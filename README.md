...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pelicanplatform-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pelicanplatform-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-pelicanplatform--server-green.svg)](https://anaconda.org/conda-forge/pelicanplatform-server) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/pelicanplatform-server.svg)](https://anaconda.org/conda-forge/pelicanplatform-server) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/pelicanplatform-server.svg)](https://anaconda.org/conda-forge/pelicanplatform-server) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/pelicanplatform-server.svg)](https://anaconda.org/conda-forge/pelicanplatform-server) |
...
```
conda install pelicanplatform pelicanplatform-server
```
...
```
mamba install pelicanplatform pelicanplatform-server
```
...
pixi add pelicanplatform pelicanplatform-server
# for installing globally
pixi global install pelicanplatform pelicanplatform-server
```
...
It is possible to list all of the versions of `pelicanplatform` available on your platform:
...
```
pixi search pelicanplatform --channel conda-forge
```
